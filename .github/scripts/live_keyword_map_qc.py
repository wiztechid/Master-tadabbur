...
def main() -> int:
    ...
    lines = [
        ...
        f"- Deep SERP boundary 001–024: {summary['deep_serp_boundary_pass_count']} / 24",
        f"- Directional boundary 025–047: {summary['directional_boundary_pass_count']} / 23",
