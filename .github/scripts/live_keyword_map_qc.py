...
def main() -> int:
    ...
    lines = [
        ...
        f"- Deep SERP boundary 001–028: {summary['deep_serp_boundary_pass_count']} / 28",
        f"- Directional boundary 029–047: {summary['directional_boundary_pass_count']} / 19",
